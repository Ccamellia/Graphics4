...
function divideTetra(a,b,c,d,k){
	...
	if(k>0){
		//计算各边的中点
		mid[0]=mult(0.25,add(a,b));
		mid[1]=mult(0.25,add(a,c));
		mid[2]=mult(0.25,add(a,d));
		mid[3]=mult(0.25,add(b,c));
		mid[4]=mult(0.25,add(c,d));
		mid[5]=mult(0.25,add(b,d));
...
window.onload = function main()
{
	...
	//指定三角形的三个顶点
	var vertices = [vec3(-0.75,-1.0,-1.0),	//前方中心点
					vec3(-0.75,-0.2,-0.3333),//底面上方点
					vec3(-1.0,-0.7,-0.3333),//底面左下点
					vec3(-0.5,-0.7,-0.3333),//底面右下点
					
					vec3(0.75,0.4,-1.0),//前方中心点
